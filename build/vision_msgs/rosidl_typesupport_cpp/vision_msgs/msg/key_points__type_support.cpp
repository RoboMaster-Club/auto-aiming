...
static const _KeyPoints_type_support_symbol_names_t _KeyPoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, KeyPoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_msgs, msg, KeyPoints)),
  }
};
...
{
  return &::vision_msgs::msg::rosidl_typesupport_cpp::KeyPoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vision_msgs, msg, KeyPoints)() {
  return get_message_type_support_handle<vision_msgs::msg::KeyPoints>();
}
