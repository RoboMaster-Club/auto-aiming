...
#include "vision_msgs/msg/detail/key_points__rosidl_typesupport_fastrtps_c.h"
...
using _KeyPoints__ros_msg_type = vision_msgs__msg__KeyPoints;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: is_large_armor
  {
    cdr << (ros_message->is_large_armor ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: is_large_armor
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_large_armor = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name is_large_armor
  {
    size_t item_size = sizeof(ros_message->is_large_armor);
...
static uint32_t _KeyPoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__KeyPoints(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__KeyPoints;
    is_plain =
      (
      offsetof(DataType, is_large_armor) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _KeyPoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__KeyPoints(
